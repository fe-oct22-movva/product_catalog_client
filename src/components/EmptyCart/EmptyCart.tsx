...
export const EmptyCart = () => (
  <div className="empty-cart">
    ...
    <svg className="empty-cart--main" viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink">
      <rect id="bg-line" stroke="none" fillOpacity="0.2" fill="#FFE100" fillRule="evenodd" x="656" y="624" width="206"
        height="38" rx="19"></rect>
      <rect id="bg-line" stroke="none" fillOpacity="0.2" fill="#FFE100" fillRule="evenodd" x="692" y="665" width="192"
        height="29" rx="14.5"></rect>
      <rect id="bg-line" stroke="none" fillOpacity="0.2" fill="#FFE100" fillRule="evenodd" x="678" y="696" width="192"
        height="33" rx="16.5"></rect>
      <g id="shopping-bag" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"
        ...
        <path
          ...
          id="Stroke-4916" stroke="#000000" strokeWidth="3" strokeLinecap="round"></path>
        <polyline id="Stroke-4917" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
        ...
        <polygon id="Stroke-4922" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
        ...
        <path d="M87,46 L87,58.3333333 C87,71.9 75.75,83 62,83 L62,83 C48.25,83 37,71.9 37,58.3333333 L37,46"
          id="Stroke-4923" stroke="#000000" strokeWidth="3" strokeLinecap="round"></path>
        <path d="M31,45 C31,41.686 33.686,39 37,39 C40.314,39 43,41.686 43,45" id="Stroke-4924" stroke="#000000"
          strokeWidth="3" strokeLinecap="round"></path>
      ...
      <g id="glow" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"
      ...
      <polygon id="plus" stroke="none" fill="#7DBFEB" fillRule="evenodd"
      ...
      <polygon id="plus" stroke="none" fill="#EEE332" fillRule="evenodd"
      ...
      <polygon id="plus" stroke="none" fill="#FFA800" fillRule="evenodd"
      ...
      <polygon id="diamond" stroke="#C46F82" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"
      ...
      <path
        ...
        id="bubble-rounded" stroke="#3CBC83" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"
        fill="none"></path>
    </svg>
