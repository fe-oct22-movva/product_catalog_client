  ...
  return (
    <div className="burger">
      <div className="burger__header">
        ...
        <a href="#close" className="header__link-close" onClick={toggleMenu}>
      ...
      <ul className="burger__list">
        <li className="burger__item">
          <a href="#home" className="burger__link">
            Home
          </a>
        </li>
        <li className="burger__item">
          <a href="#Phones" className="burger__link">
            Phones
          </a>
        </li>
        <li className="burger__item">
        ...
        <li className="burger__item">
          <a href="#Accessories" className="burger__link">
            Accessories
          </a>
        </li>
      </ul>
